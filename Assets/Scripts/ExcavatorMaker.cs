...
public class ExcavatorMaker : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        wheelBasePath[0] = Matrix4x4.Translate(new Vector3(0f, 0.0f, 0f)) *
                           Matrix4x4.Scale(new Vector3(0, 0, 0));
        wheelBasePath[1] = Matrix4x4.Translate(new Vector3(0f, 0.0f, 0f)) *
                           Matrix4x4.Scale(new Vector3(2.0f, 0.4f, 2.0f));
        wheelBasePath[2] = Matrix4x4.Translate(new Vector3(0f, 0.4f, 0f)) *
                           Matrix4x4.Scale(new Vector3(2.0f, 0.4f, 2.0f));
        wheelBasePath[3] = Matrix4x4.Translate(new Vector3(0f, 0.4f, 0f)) *
                           Matrix4x4.Scale(new Vector3(0, 0, 0));
        ...
        turntableJoint.transform.localPosition = new Vector3(0f, 0.4f, 0f);
        ...
        turntable.transform.localPosition = new Vector3(0f, 0.15f, 0f);
        ...
        bodyPath[0] = Matrix4x4.Translate(new Vector3(0f, 0.0f, 0f)) *
                      Matrix4x4.Scale(new Vector3(0, 0, 0));
        bodyPath[1] = Matrix4x4.Translate(new Vector3(0f, 0.0f, 0f)) *
                      Matrix4x4.Scale(new Vector3(2.5f, 1f, 2.5f));
        bodyPath[2] = Matrix4x4.Translate(new Vector3(0f, 0.8f, 0f)) *
                      Matrix4x4.Scale(new Vector3(2.5f, 1f, 2.5f));
        bodyPath[3] = Matrix4x4.Translate(new Vector3(0f, 0.8f, 0f)) *
                      Matrix4x4.Scale(new Vector3(0, 0, 0));
        ...
        cabPath[0] = Matrix4x4.Translate(new Vector3(0f, 0.0f, 0f)) *
                     Matrix4x4.Scale(new Vector3(0, 0, 0));
        cabPath[1] = Matrix4x4.Translate(new Vector3(0f, 0.0f, 0f)) *
                     Matrix4x4.Scale(new Vector3(1.25f, 1f, 1.0f));
        cabPath[2] = Matrix4x4.Translate(new Vector3(0f, 1.3f, 0f)) *
                     Matrix4x4.Scale(new Vector3(1.25f, 1f, 1.0f));
        cabPath[3] = Matrix4x4.Translate(new Vector3(0f, 1.3f, 0f)) *
                     Matrix4x4.Scale(new Vector3(0, 0, 0));
